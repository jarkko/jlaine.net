...
**[]{lang="UPDATE"}** Should have knocked the wood a few times more. We were on Kottke and TechCrunch just about the same time, and man, that shows. A new server is on its way, but before that, please bare with us.
