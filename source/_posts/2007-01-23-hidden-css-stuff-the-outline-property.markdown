...
`<a href="http://www.flickr.com/photos/jarkko/366928823/" title="Photo Sharing">`{=html}`<img src="http://farm1.static.flickr.com/162/366928823_d5486f8cd0_o.png" width="529" height="263" alt="Outline issue with the Phark method" />`{=html}`</a>`{=html}
