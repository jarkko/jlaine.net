...
`<param name="movie" value="http://www.youtube.com/v/s2J4gQEy4DA">`{=html}`</param>`{=html}`<param name="wmode" value="transparent">`{=html}`</param>`{=html}`<embed src="http://www.youtube.com/v/s2J4gQEy4DA" type="application/x-shockwave-flash" wmode="transparent" width="425" height="350">`{=html}`</embed>`{=html}`</object>`{=html}
