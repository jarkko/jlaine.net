...
If you dislike Palatino, you can of course edit the CSS to your heart's content. For me, the biggest beef were the `<a href="http://en.wikipedia.org/wiki/River_(typography)">`{=html}rivers`</a>`{=html} flowing through the text when using the default justified alignment.
