...
![Countdown to RailsConf](http://nubyonrails.com/images/typo_graphs/countdown_railsconf.png "Countdown to RailsConf")
...
The clerk at the passport control: What are you here for, mister Lane?`<br />`{=html}\
Me: Line-eh. I'm here for a conference.`<br />`{=html}\
Clerk: So what do you do, mister Lane?`<br />`{=html}\
Me: I'm a web hacker (oops, think, man, think!)`<br />`{=html}\
Clerk: Oh, a web developer?`<br />`{=html}\
Me: Yes, that is correct.`<br />`{=html}\
Clerk: Ok, left index finger, please... right index finger, please... look at the camera, please... have a good day, sir.

Customs clerk: What kind of food do you carry?`<br />`{=html}\
Me: Just some Finnish rye bread.`<br />`{=html}\
