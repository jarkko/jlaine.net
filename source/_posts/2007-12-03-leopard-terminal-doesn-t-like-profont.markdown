...
![Leopard Terminal fucks royally up strings with slashes with ProFont](http://jlaine.net/assets/2007/12/2/Leopard_Terminal_with_ProFont-1.jpg "Leopard Terminal fucks royally up strings with slashes with ProFont")

Not cool. Here's exactly the same window after switching the font to Bitstream Vera Sans Mono:

![In Vera Sans Mono everything\'s fine](http://jlaine.net/assets/2007/12/2/Leopard_Terminal_with_Vera_Sans_Mono.jpg "In Vera Sans Mono everything's fine")
