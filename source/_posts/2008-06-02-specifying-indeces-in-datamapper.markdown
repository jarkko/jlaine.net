...
```
<code class="ruby">property :last_name,    String, :index => true
</code>
```
...
```
<code class="ruby">property :last_name,    String, :unique_index => true
</code>
```
...
```
<code class="ruby">property :last_name,     String, :index => :name
