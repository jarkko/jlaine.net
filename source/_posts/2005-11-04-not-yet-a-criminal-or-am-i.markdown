...
> If you think that this cannot get any dumber, you would be wrong. The coup de grace of this exercise in corporate stupidity is this:`<br />`{=html}`<br/>`{=html}"If you have a Mac computer you can copy the songs using your iTunes Player as you would normally do."`<br />`{=html}`<br/>`{=html}Words simply fail me . . .
...
So is the new parasite hiding on Sony "CD's" DRM or not? You could argue that it is, because you need some minor knowledge to get music from it to iTunes *on Windows*. However, on Mac you just can't trip into that trap so it's disputable whether it can be called a DRM system at all. So I might not be criminal even if I copy such a disc on my Mac[^1].
...
[^1]: Not that I would ever buy such a fucker. I'm on a mission now, together with many commenters in the [original post](http://bigpicture.typepad.com/comments/2005/10/drm_crippled_cd.html). I will never, ever buy a Sony product as long as their attitude towards consumers is at the current level. Supersize that.
